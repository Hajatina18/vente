    ...
    <div class="commande-content w-100">
        <div class="card card-commande bg-white">
            <div class="border-solid rounded">
                ...
                <div class="modal fade" id="modalModif" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-center" id="exampleModalLabel">Modification d'un transfert
                                </h5>
                            ...
                            <form action="" method="post" id="formModifProd">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input tytransfert-pe="text" class="form-control" id="modif_nom" name="nom_prod"
                                            required>
                                    </div>
            ...
            @push('js')
                <script type="text/javascript">
                    ...
                    $("#id_approvisionneur").on('change', '#id_approvisionneur', function() {
                        var approvisionneur = ('#id_approvisionneur').val();
                        console.log(approvisionneur);
                        // var produit = $('#produit');
                        // var unite = $('#unite');
                        // var qte = $('#qte').val();
