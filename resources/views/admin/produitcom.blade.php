        ...
        <div class="card card-commande bg-white">
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="table-responsive margin-left-40px ">
                            <table class="table table-striped ml-4px" id="liste">
                                <thead>
                                    <th>Réference</th>
                                    <th>Designation</th>
                                    <th>Image</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="my-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="fait_demandeModif" value="true"
                                    id="demandeOuiModif">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="fait_demandeModif" value="false"
                                    id="demandeNomModif" checked>
...
@push('js')
    <script type="text/javascript">
        ...
        $(".add").on('click', function() {
            $(this).parents('tbody').append('<tr><td><select class="form-select" id="unite" name="unite">' + unite +
                '</select></td><td><input type="number" class="form-control" id="prix" name="prix" required></td><td><input type="text" class="form-control" id="qte" name="qte" required></td><td><button type="button" class="btn btn-outline-secondary delete"><i class="las la-trash"></i></button></td></tr>'
                );
        });
        ...
        function getProduit(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("[name=fait_demandeModif][value=" + Boolean(response.fait_demande) + "]").prop('checked',
                        true);
                    $("#modif_unite_mesure > tbody").empty();
                    response.unite.forEach(element => {
                        $("#modif_unite_mesure > tbody").append(
                            '<tr><td><input type="text" class="form-control" name="unite" id="modif_unite" data-id="' +
                            element.id_unite + '" value="' + element.unite +
                            '" readonly></td><td><input type="number" class="form-control" id="modif_prix" name="prix" value="' +
                            element.prix +
                            '" required></td><td><input type="text" class="form-control" id="modif_qte" name="qte" value="' +
                            element.qte_unite + '" required></td></tr>')
                    });
